        ...
        <div className="container-fluid row tengah">
          <div className="container col-md-6 text-start" data-aos="fade-right" style={{paddingLeft:"150px"}}>
              ...
              <div className="d-flex gap-3">
                  ...
                  <button className="btn btn-outline-primary rounded-pill"><i className='bx bx-right-arrow' ></i>Detail</button>
              </div>
          </div>
      ...
      <section>
        <div className="container-fluid tengah my-5 gap-3" data-aos="flip-up">
            <div class="card logo" style={{border:"none"}}>
                <Image src="/pesawat1.svg" width={300} height={300} className="card-img" alt="logo1"/>
            </div>
            <div class="card logo" style={{border:"none"}}>
                <Image src="/pesawat2.svg" width={300} height={300} className="card-img" alt="logo2"/>
            </div>
            <div class="card logo" style={{border:"none"}}>
                <Image src="/pesawat3.svg" width={300} height={300} className="card-img" alt="logo3"/>
            </div>
            <div class="card logo" style={{border:"none"}}>
                <Image src="/pesawat4.svg" width={300} height={300} className="card-img" alt="logo4"/>
            </div>
            <div class="card logo" style={{border:"none"}}>
                <Image src="/pesawat5.svg" width={300} height={300} className="card-img" alt="logo5"/>
            </div>
        </div>
      </section>
